...
const sobreSkill = [
                    ...
                    '<p>Next.JS</p> <br> <p>O Next.js é um framework React que permite construir sites e aplicativos web estáticos otimizados, altamente interativos e focados na experiência do usuário.</p> <br>',
                    '<p>SQL</p> <br> <p>É uma linguagem para trabalhar com bancos de dados relacionais, amplamente utilizada por profissionais em diversas áreas.</p> <br>',
                    '<p>Segurança da informação</p> <br> <p>É à defesa de dados e à prática que assegura que informações sigilosas possam ser acessadas somente por aqueles a quem estas se referem.</p> <br>',
